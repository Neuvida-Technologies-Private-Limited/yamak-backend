...
urlpatterns = [
    # sentry testing path
    path(f'{API_MODULE}/sentry-debug', sentry_service.trigger_error, name='sentry-debug'),
    ...
    path(f'{API_MODULE}/get-disptach-center', access.GetDispatchCenterView.as_view(), name='get-disptach-center'),
