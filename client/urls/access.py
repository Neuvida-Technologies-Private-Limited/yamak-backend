...
urlpatterns = [
    ...
    # Admin views
    path(f'{API_MODULE}/add_user', access.AddUserView.as_view(), name='add_user'),
    ...
    path(f'{API_MODULE}/delete_account', access.DeleteAccountView.as_view(), name='delete_account'),
]
